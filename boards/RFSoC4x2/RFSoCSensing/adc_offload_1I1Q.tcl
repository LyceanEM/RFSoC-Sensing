...
################################################################
# This is a generated script based on design: adc_offload
#
...
\
  ...
  set_property CONFIG.TDATA_NUM_BYTES {16} $axis_clock_converter_0
  ...
  set_property -dict [list \
    ...
    CONFIG.TDATA_REMAP {tdata[127:112], tdata[63:48], tdata[111:96], tdata[47:32], tdata[95:80], tdata[31:16], tdata[79:64], tdata[15:0]} \
  ...
  set_property -dict [list \
    ...
    CONFIG.TDATA_REMAP {tdata[511:480] ,tdata[383:352] ,tdata[255:224] ,tdata[127:96], tdata[479:448] ,tdata[351:320] ,tdata[223:192] ,tdata[95:64], tdata[447:416] ,tdata[319:288] ,tdata[191:160] ,tdata[63:32],\
tdata[415:384] ,tdata[287:256] ,tdata[159:128] ,tdata[31:0]} \
  ...
  set_property CONFIG.TDATA_NUM_BYTES {16} $axis_clock_converter_1
  ...
  connect_bd_intf_net -intf_net axis_clock_converter_0_M_AXIS [get_bd_intf_pins axis_clock_converter_0/M_AXIS] [get_bd_intf_pins axis_combiner_2/S00_AXIS]
  connect_bd_intf_net -intf_net axis_clock_converter_1_M_AXIS [get_bd_intf_pins axis_clock_converter_1/M_AXIS] [get_bd_intf_pins axis_combiner_2/S01_AXIS]
  connect_bd_intf_net -intf_net axis_combiner_1_M_AXIS [get_bd_intf_pins axis_combiner_1/M_AXIS] [get_bd_intf_pins axis_subset_converter_0/S_AXIS]
  connect_bd_intf_net -intf_net axis_combiner_1_M_AXIS1 [get_bd_intf_pins axis_combiner_3/M_AXIS] [get_bd_intf_pins axis_subset_converter_1/S_AXIS]
  connect_bd_intf_net -intf_net axis_combiner_1_M_AXIS2 [get_bd_intf_pins axis_combiner_4/M_AXIS] [get_bd_intf_pins axis_subset_converter_3/S_AXIS]
  connect_bd_intf_net -intf_net axis_combiner_2_M_AXIS [get_bd_intf_pins axis_combiner_2/M_AXIS] [get_bd_intf_pins axis_subset_converter_2/S_AXIS]
  connect_bd_intf_net -intf_net axis_combiner_5_M_AXIS [get_bd_intf_pins axis_combiner_5/M_AXIS] [get_bd_intf_pins axis_subset_converter_4/S_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_subset_converter_0_M_AXIS [get_bd_intf_pins axis_subset_converter_0/M_AXIS] [get_bd_intf_pins axis_clock_converter_0/S_AXIS]
  connect_bd_intf_net -intf_net axis_subset_converter_1_M_AXIS [get_bd_intf_pins axis_subset_converter_1/M_AXIS] [get_bd_intf_pins axis_clock_converter_1/S_AXIS]
  connect_bd_intf_net -intf_net axis_subset_converter_2_M_AXIS [get_bd_intf_pins axis_subset_converter_2/M_AXIS] [get_bd_intf_pins packet_generator/S_AXIS]
  connect_bd_intf_net -intf_net axis_subset_converter_3_M_AXIS [get_bd_intf_pins axis_subset_converter_3/M_AXIS] [get_bd_intf_pins axis_combiner_2/S02_AXIS]
  connect_bd_intf_net -intf_net axis_subset_converter_4_M_AXIS [get_bd_intf_pins axis_subset_converter_4/M_AXIS] [get_bd_intf_pins axis_combiner_2/S03_AXIS]
  ...
  connect_bd_intf_net -intf_net rfdc_m00_axis [get_bd_intf_pins rfdc/m00_axis] [get_bd_intf_pins axis_combiner_1/S00_AXIS]
  connect_bd_intf_net -intf_net rfdc_m01_axis [get_bd_intf_pins rfdc/m01_axis] [get_bd_intf_pins axis_combiner_1/S01_AXIS]
  connect_bd_intf_net -intf_net rfdc_m02_axis [get_bd_intf_pins rfdc/m02_axis] [get_bd_intf_pins axis_combiner_3/S00_AXIS]
  connect_bd_intf_net -intf_net rfdc_m03_axis [get_bd_intf_pins rfdc/m03_axis] [get_bd_intf_pins axis_combiner_3/S01_AXIS]
  connect_bd_intf_net -intf_net rfdc_m20_axis [get_bd_intf_pins rfdc/m20_axis] [get_bd_intf_pins axis_combiner_4/S00_AXIS]
  connect_bd_intf_net -intf_net rfdc_m21_axis [get_bd_intf_pins rfdc/m21_axis] [get_bd_intf_pins axis_combiner_4/S01_AXIS]
  connect_bd_intf_net -intf_net rfdc_m22_axis [get_bd_intf_pins rfdc/m22_axis] [get_bd_intf_pins axis_combiner_5/S00_AXIS]
  connect_bd_intf_net -intf_net rfdc_m23_axis [get_bd_intf_pins rfdc/m23_axis] [get_bd_intf_pins axis_combiner_5/S01_AXIS]
  ...
  connect_bd_net -net rfdc_clk_adc0 [get_bd_pins rfdc/clk_adc0] [get_bd_pins rfdc/m0_axis_aclk] [get_bd_pins rst_307M3/slowest_sync_clk] [get_bd_pins axis_combiner_1/aclk] [get_bd_pins axis_clock_converter_0/s_axis_aclk] [get_bd_pins axis_subset_converter_0/aclk] [get_bd_pins axis_combiner_3/aclk] [get_bd_pins axis_subset_converter_1/aclk] [get_bd_pins axis_clock_converter_1/s_axis_aclk]
  ...
  connect_bd_net -net rst_307M2_peripheral_aresetn [get_bd_pins rst_307M2/peripheral_aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins packet_generator/aresetn] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins rfdc/m2_axis_aresetn] [get_bd_pins axis_combiner_2/aresetn] [get_bd_pins axis_clock_converter_0/m_axis_aresetn] [get_bd_pins axis_subset_converter_2/aresetn] [get_bd_pins axis_combiner_4/aresetn] [get_bd_pins axis_combiner_5/aresetn] [get_bd_pins axis_subset_converter_4/aresetn] [get_bd_pins axis_subset_converter_3/aresetn] [get_bd_pins axis_clock_converter_1/m_axis_aresetn]
  ...
  connect_bd_net -net rst_307M3_peripheral_aresetn1 [get_bd_pins rst_307M3/peripheral_aresetn] [get_bd_pins rfdc/m0_axis_aresetn] [get_bd_pins axis_combiner_1/aresetn] [get_bd_pins axis_clock_converter_0/s_axis_aresetn] [get_bd_pins axis_subset_converter_0/aresetn] [get_bd_pins axis_combiner_3/aresetn] [get_bd_pins axis_subset_converter_1/aresetn] [get_bd_pins axis_clock_converter_1/s_axis_aresetn]
  ...
  connect_bd_net -net usp_rf_data_converter_0_clk_adc2 [get_bd_pins rfdc/clk_adc2] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins packet_generator/aclk] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins rfdc/m2_axis_aclk] [get_bd_pins rst_307M2/slowest_sync_clk] [get_bd_pins axis_combiner_2/aclk] [get_bd_pins axis_clock_converter_0/m_axis_aclk] [get_bd_pins axis_subset_converter_2/aclk] [get_bd_pins axis_combiner_5/aclk] [get_bd_pins axis_subset_converter_4/aclk] [get_bd_pins axis_combiner_4/aclk] [get_bd_pins axis_subset_converter_3/aclk] [get_bd_pins axis_clock_converter_1/m_axis_aclk]
