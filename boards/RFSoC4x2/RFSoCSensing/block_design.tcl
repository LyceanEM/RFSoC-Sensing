...
tdata[159:144], tdata[31:16], tdata[143:128], tdata[15:0]} \
  ...
  # Create instance: axis_data_fifo_ch4, and set properties
  set axis_data_fifo_ch4 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 axis_data_fifo_ch4 ]
  set_property -dict [list \
    CONFIG.FIFO_DEPTH {1024} \
    CONFIG.FIFO_MODE {2} \
    CONFIG.IS_ACLK_ASYNC {0} \
  ...
  connect_bd_intf_net -intf_net axis_data_fifo_ch4_M_AXIS [get_bd_intf_pins axis_data_fifo_ch4/M_AXIS] [get_bd_intf_pins netlayer_switch/S01_AXIS]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M09_AXI [get_bd_intf_pins ps8_0_axi_periph/M09_AXI] [get_bd_intf_pins packet_generator3/S_AXI_Lite]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M10_AXI [get_bd_intf_pins ps8_0_axi_periph/M10_AXI] [get_bd_intf_pins packet_generator0/S_AXI_Lite]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M11_AXI [get_bd_intf_pins ps8_0_axi_periph/M11_AXI] [get_bd_intf_pins packet_generator1/S_AXI_Lite]
  ...
  connect_bd_intf_net -intf_net switchDest_dataOut [get_bd_intf_pins switchDest/dataOut] [get_bd_intf_pins axis_data_fifo_ch4/S_AXIS]
  ...
  connect_bd_net -net rst_307M2_peripheral_aresetn [get_bd_pins rst_307M2/peripheral_aresetn] [get_bd_pins axis_combiner_0/aresetn] [get_bd_pins axis_data_fifo_ch2/s_axis_aresetn] [get_bd_pins axis_ssr_converter_adc/aresetn] [get_bd_pins axis_subset_converter_0/aresetn] [get_bd_pins packet_generator2/aresetn] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins rfdc/m2_axis_aresetn] [get_bd_pins axis_combiner_1/aresetn] [get_bd_pins axis_subset_converter_1/aresetn] [get_bd_pins axis_ssr_converter_adc1/aresetn] [get_bd_pins packet_generator3/aresetn] [get_bd_pins axis_data_fifo_ch3/s_axis_aresetn] [get_bd_pins ps8_0_axi_periph/M09_ARESETN]
  ...
  connect_bd_net -net rst_ps8_0_gt_tx_peripheral_aresetn [get_bd_pins rst_ps8_0_gt_tx/peripheral_aresetn] [get_bd_pins dma_fifo_rx/s_axis_aresetn] [get_bd_pins netlayer/ap_rst_n] [get_bd_pins netlayer_switch/aresetn] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins tx_fifo/s_axis_aresetn] [get_bd_pins axis_data_fifo_ch4/s_axis_aresetn] [get_bd_pins switchDest/ap_rst_n]
