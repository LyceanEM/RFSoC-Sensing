...
################################################################
# This is a generated script based on design: mul_streams
#
...
tdata[159:144], tdata[31:16], tdata[143:128], tdata[15:0]} \
  ...
  # Create instance: packet_generator2, and set properties
  set packet_generator2 [ create_bd_cell -type ip -vlnv strathsdr.com:strathsdr:axis_packet_generator:1.0 packet_generator2 ]
  set_property CONFIG.C_S_AXIS_DATA_WIDTH {512} $packet_generator2
...
\
  ...
  # Create instance: switchDest, and set properties
  set switchDest [ create_bd_cell -type ip -vlnv xilinx.com:hls:switchDest:1.0 switchDest ]
  ...
  set_property CONFIG.TDATA_NUM_BYTES {16} $axis_combiner_1


  # Create instance: axis_data_fifo_ch3, and set properties
  set axis_data_fifo_ch3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 axis_data_fifo_ch3 ]
  set_property -dict [list \
    CONFIG.FIFO_DEPTH {1024} \
    CONFIG.FIFO_MODE {2} \
    CONFIG.IS_ACLK_ASYNC {1} \
  ...
  set_property CONFIG.C_S_AXIS_TDATA_WIDTH {256} $axis_ssr_converter_adc1
...
tdata[159:144], tdata[31:16], tdata[143:128], tdata[15:0]} \
  ...
  # Create instance: packet_generator3, and set properties
  set packet_generator3 [ create_bd_cell -type ip -vlnv strathsdr.com:strathsdr:axis_packet_generator:1.0 packet_generator3 ]
  set_property CONFIG.C_S_AXIS_DATA_WIDTH {512} $packet_generator3
  ...
  set_property CONFIG.TDATA_NUM_BYTES {16} $axis_combiner_2


  # Create instance: axis_data_fifo_ch0, and set properties
  set axis_data_fifo_ch0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 axis_data_fifo_ch0 ]
  set_property -dict [list \
    CONFIG.FIFO_DEPTH {1024} \
    CONFIG.FIFO_MODE {2} \
    CONFIG.IS_ACLK_ASYNC {1} \
  ...
  # Create instance: axis_ssr_converter_adc2, and set properties
  set axis_ssr_converter_adc2 [ create_bd_cell -type ip -vlnv strathsdr.com:strathsdr:axis_ssr_converter:1.0 axis_ssr_converter_adc2 ]
  set_property CONFIG.C_S_AXIS_TDATA_WIDTH {256} $axis_ssr_converter_adc2
...
tdata[159:144], tdata[31:16], tdata[143:128], tdata[15:0]} \
  ...
  # Create instance: packet_generator0, and set properties
  set packet_generator0 [ create_bd_cell -type ip -vlnv strathsdr.com:strathsdr:axis_packet_generator:1.0 packet_generator0 ]
  set_property CONFIG.C_S_AXIS_DATA_WIDTH {512} $packet_generator0
  ...
  set_property CONFIG.TDATA_NUM_BYTES {16} $axis_combiner_3
  ...
  # Create instance: axis_ssr_converter_adc3, and set properties
  set axis_ssr_converter_adc3 [ create_bd_cell -type ip -vlnv strathsdr.com:strathsdr:axis_ssr_converter:1.0 axis_ssr_converter_adc3 ]
  set_property CONFIG.C_S_AXIS_TDATA_WIDTH {256} $axis_ssr_converter_adc3
...
tdata[159:144], tdata[31:16], tdata[143:128], tdata[15:0]} \
  ...
  # Create instance: packet_generator1, and set properties
  set packet_generator1 [ create_bd_cell -type ip -vlnv strathsdr.com:strathsdr:axis_packet_generator:1.0 packet_generator1 ]
  set_property CONFIG.C_S_AXIS_DATA_WIDTH {512} $packet_generator1
  ...
  connect_bd_intf_net -intf_net axis_combiner_0_M_AXIS [get_bd_intf_pins axis_ssr_converter_adc/M_AXIS] [get_bd_intf_pins packet_generator2/S_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_combiner_0_M_AXIS2 [get_bd_intf_pins axis_ssr_converter_adc1/M_AXIS] [get_bd_intf_pins packet_generator3/S_AXIS]
  connect_bd_intf_net -intf_net axis_combiner_0_M_AXIS3 [get_bd_intf_pins axis_combiner_1/M_AXIS] [get_bd_intf_pins axis_subset_converter_1/S_AXIS]
  connect_bd_intf_net -intf_net axis_combiner_0_M_AXIS4 [get_bd_intf_pins axis_ssr_converter_adc2/M_AXIS] [get_bd_intf_pins packet_generator0/S_AXIS]
  connect_bd_intf_net -intf_net axis_combiner_0_M_AXIS5 [get_bd_intf_pins axis_combiner_2/M_AXIS] [get_bd_intf_pins axis_subset_converter_2/S_AXIS]
  connect_bd_intf_net -intf_net axis_combiner_0_M_AXIS6 [get_bd_intf_pins axis_ssr_converter_adc3/M_AXIS] [get_bd_intf_pins packet_generator1/S_AXIS]
  connect_bd_intf_net -intf_net axis_combiner_0_M_AXIS7 [get_bd_intf_pins axis_combiner_3/M_AXIS] [get_bd_intf_pins axis_subset_converter_3/S_AXIS]
  connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS [get_bd_intf_pins axis_data_fifo_ch2/M_AXIS] [get_bd_intf_pins switchDest/dataIn3]
  ...
  connect_bd_intf_net -intf_net axis_data_fifo_2_M_AXIS [get_bd_intf_pins axis_data_fifo_ch3/M_AXIS] [get_bd_intf_pins switchDest/dataIn4]
  connect_bd_intf_net -intf_net axis_data_fifo_3_M_AXIS [get_bd_intf_pins axis_data_fifo_ch0/M_AXIS] [get_bd_intf_pins switchDest/dataIn1]
  connect_bd_intf_net -intf_net axis_data_fifo_4_M_AXIS [get_bd_intf_pins axis_data_fifo_ch1/M_AXIS] [get_bd_intf_pins switchDest/dataIn2]
  ...
  connect_bd_intf_net -intf_net axis_packet_generator_0_M_AXIS [get_bd_intf_pins axis_data_fifo_ch2/S_AXIS] [get_bd_intf_pins packet_generator2/M_AXIS]
  connect_bd_intf_net -intf_net axis_packet_generator_0_M_AXIS1 [get_bd_intf_pins axis_data_fifo_ch3/S_AXIS] [get_bd_intf_pins packet_generator3/M_AXIS]
  connect_bd_intf_net -intf_net axis_packet_generator_0_M_AXIS2 [get_bd_intf_pins axis_data_fifo_ch0/S_AXIS] [get_bd_intf_pins packet_generator0/M_AXIS]
  connect_bd_intf_net -intf_net axis_packet_generator_0_M_AXIS3 [get_bd_intf_pins axis_data_fifo_ch1/S_AXIS] [get_bd_intf_pins packet_generator1/M_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_subset_converter_0_M_AXIS1 [get_bd_intf_pins axis_ssr_converter_adc1/S_AXIS] [get_bd_intf_pins axis_subset_converter_1/M_AXIS]
  connect_bd_intf_net -intf_net axis_subset_converter_0_M_AXIS2 [get_bd_intf_pins axis_ssr_converter_adc2/S_AXIS] [get_bd_intf_pins axis_subset_converter_2/M_AXIS]
  connect_bd_intf_net -intf_net axis_subset_converter_0_M_AXIS3 [get_bd_intf_pins axis_ssr_converter_adc3/S_AXIS] [get_bd_intf_pins axis_subset_converter_3/M_AXIS]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M03_AXI [get_bd_intf_pins packet_generator2/S_AXI_Lite] [get_bd_intf_pins ps8_0_axi_periph/M03_AXI]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M09_AXI [get_bd_intf_pins ps8_0_axi_periph/M09_AXI] [get_bd_intf_pins switchDest/s_axi_BUS_A]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M10_AXI [get_bd_intf_pins packet_generator3/S_AXI_Lite] [get_bd_intf_pins ps8_0_axi_periph/M10_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M11_AXI [get_bd_intf_pins ps8_0_axi_periph/M11_AXI] [get_bd_intf_pins packet_generator0/S_AXI_Lite]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M12_AXI [get_bd_intf_pins ps8_0_axi_periph/M12_AXI] [get_bd_intf_pins packet_generator1/S_AXI_Lite]
  connect_bd_intf_net -intf_net rfdc_m00_axis [get_bd_intf_pins axis_combiner_2/S00_AXIS] [get_bd_intf_pins rfdc/m00_axis]
  connect_bd_intf_net -intf_net rfdc_m01_axis [get_bd_intf_pins rfdc/m01_axis] [get_bd_intf_pins axis_combiner_2/S01_AXIS]
  connect_bd_intf_net -intf_net rfdc_m02_axis [get_bd_intf_pins axis_combiner_3/S00_AXIS] [get_bd_intf_pins rfdc/m02_axis]
  connect_bd_intf_net -intf_net rfdc_m03_axis [get_bd_intf_pins axis_combiner_3/S01_AXIS] [get_bd_intf_pins rfdc/m03_axis]
  ...
  connect_bd_intf_net -intf_net rfdc_m22_axis [get_bd_intf_pins rfdc/m22_axis] [get_bd_intf_pins axis_combiner_1/S00_AXIS]
  connect_bd_intf_net -intf_net rfdc_m23_axis [get_bd_intf_pins rfdc/m23_axis] [get_bd_intf_pins axis_combiner_1/S01_AXIS]
  ...
  connect_bd_intf_net -intf_net switchDest_0_dataOut [get_bd_intf_pins switchDest/dataOut] [get_bd_intf_pins netlayer_switch/S01_AXIS]
  ...
  connect_bd_net -net rfdc_clk_adc0 [get_bd_pins rfdc/clk_adc0] [get_bd_pins rfdc/m0_axis_aclk] [get_bd_pins axis_combiner_2/aclk] [get_bd_pins rst_307M3/slowest_sync_clk] [get_bd_pins axis_subset_converter_2/aclk] [get_bd_pins axis_ssr_converter_adc2/aclk] [get_bd_pins packet_generator0/aclk] [get_bd_pins axis_data_fifo_ch0/s_axis_aclk] [get_bd_pins axis_combiner_3/aclk] [get_bd_pins axis_subset_converter_3/aclk] [get_bd_pins axis_ssr_converter_adc3/aclk] [get_bd_pins packet_generator1/aclk] [get_bd_pins axis_data_fifo_ch1/s_axis_aclk] [get_bd_pins ps8_0_axi_periph/M11_ACLK] [get_bd_pins ps8_0_axi_periph/M12_ACLK]
  connect_bd_net -net rfdc_clk_dac0 [get_bd_pins rfdc/clk_dac0] [get_bd_pins axis_data_fifo_1/m_axis_aclk] [get_bd_pins clk_wiz_1/clk_in1] [get_bd_pins fifo_controller/aclk] [get_bd_pins ps8_0_axi_periph/M08_ACLK] [get_bd_pins rfdc/s0_axis_aclk] [get_bd_pins rst_dac_153M6/slowest_sync_clk]
  connect_bd_net -net rst_307M2_peripheral_aresetn [get_bd_pins rst_307M2/peripheral_aresetn] [get_bd_pins axis_combiner_0/aresetn] [get_bd_pins axis_data_fifo_ch2/s_axis_aresetn] [get_bd_pins axis_ssr_converter_adc/aresetn] [get_bd_pins axis_subset_converter_0/aresetn] [get_bd_pins packet_generator2/aresetn] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins rfdc/m2_axis_aresetn] [get_bd_pins axis_combiner_1/aresetn] [get_bd_pins axis_subset_converter_1/aresetn] [get_bd_pins axis_ssr_converter_adc1/aresetn] [get_bd_pins packet_generator3/aresetn] [get_bd_pins axis_data_fifo_ch3/s_axis_aresetn] [get_bd_pins ps8_0_axi_periph/M10_ARESETN]
  connect_bd_net -net rst_307M3_peripheral_aresetn [get_bd_pins rst_dac_153M6/peripheral_aresetn] [get_bd_pins clk_wiz_1/resetn] [get_bd_pins fifo_controller/aresetn] [get_bd_pins ps8_0_axi_periph/M08_ARESETN] [get_bd_pins rfdc/s0_axis_aresetn]
  connect_bd_net -net rst_307M3_peripheral_aresetn1 [get_bd_pins rst_307M3/peripheral_aresetn] [get_bd_pins rfdc/m0_axis_aresetn] [get_bd_pins axis_combiner_2/aresetn] [get_bd_pins axis_subset_converter_2/aresetn] [get_bd_pins axis_ssr_converter_adc2/aresetn] [get_bd_pins packet_generator0/aresetn] [get_bd_pins axis_data_fifo_ch0/s_axis_aresetn] [get_bd_pins axis_combiner_3/aresetn] [get_bd_pins axis_subset_converter_3/aresetn] [get_bd_pins axis_ssr_converter_adc3/aresetn] [get_bd_pins packet_generator1/aresetn] [get_bd_pins axis_data_fifo_ch1/s_axis_aresetn] [get_bd_pins ps8_0_axi_periph/M11_ARESETN] [get_bd_pins ps8_0_axi_periph/M12_ARESETN]
  connect_bd_net -net rst_dac_333M_peripheral_aresetn [get_bd_pins rst_dac_333M/peripheral_aresetn] [get_bd_pins axi_dma_dac/axi_resetn] [get_bd_pins axis_data_fifo_1/s_axis_aresetn] [get_bd_pins axis_ssr_converter_dac/aresetn] [get_bd_pins axis_tkeep_pack_0/aresetn] [get_bd_pins ps8_0_axi_periph/M06_ARESETN] [get_bd_pins smartconnect_0/aresetn]
  connect_bd_net -net rst_ps8_0_96M_peripheral_aresetn [get_bd_pins rst_ps8_0_96M/peripheral_aresetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins clk_wiz_0/resetn] [get_bd_pins netlayer_switch/s_axi_ctrl_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M04_ARESETN] [get_bd_pins ps8_0_axi_periph/M05_ARESETN] [get_bd_pins ps8_0_axi_periph/M07_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rfdc/s_axi_aresetn]
  ...
  connect_bd_net -net rst_ps8_0_gt_tx_peripheral_aresetn [get_bd_pins rst_ps8_0_gt_tx/peripheral_aresetn] [get_bd_pins dma_fifo_rx/s_axis_aresetn] [get_bd_pins netlayer/ap_rst_n] [get_bd_pins netlayer_switch/aresetn] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins tx_fifo/s_axis_aresetn] [get_bd_pins ps8_0_axi_periph/M09_ARESETN] [get_bd_pins switchDest/ap_rst_n]
  ...
  connect_bd_net -net usp_rf_data_converter_0_clk_adc2 [get_bd_pins rfdc/clk_adc2] [get_bd_pins axis_combiner_0/aclk] [get_bd_pins axis_data_fifo_ch2/s_axis_aclk] [get_bd_pins axis_ssr_converter_adc/aclk] [get_bd_pins axis_subset_converter_0/aclk] [get_bd_pins packet_generator2/aclk] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins rfdc/m2_axis_aclk] [get_bd_pins rst_307M2/slowest_sync_clk] [get_bd_pins axis_combiner_1/aclk] [get_bd_pins axis_subset_converter_1/aclk] [get_bd_pins axis_ssr_converter_adc1/aclk] [get_bd_pins packet_generator3/aclk] [get_bd_pins axis_data_fifo_ch3/s_axis_aclk] [get_bd_pins ps8_0_axi_periph/M10_ACLK]
  ...
  assign_bd_address -offset 0xA00E0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs packet_generator0/S_AXI_Lite/reg0] -force
  assign_bd_address -offset 0xA00C0000 -range 0x00010000 -with_name SEG_packet_generator1_reg0 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs packet_generator3/S_AXI_Lite/reg0] -force
  assign_bd_address -offset 0xA00F0000 -range 0x00010000 -with_name SEG_packet_generator1_reg0_1 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs packet_generator1/S_AXI_Lite/reg0] -force
  assign_bd_address -offset 0xA0030000 -range 0x00010000 -with_name SEG_packet_generator_reg0 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs packet_generator2/S_AXI_Lite/reg0] -force
  ...
  assign_bd_address -offset 0xA00D0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs switchDest/s_axi_BUS_A/Reg] -force
