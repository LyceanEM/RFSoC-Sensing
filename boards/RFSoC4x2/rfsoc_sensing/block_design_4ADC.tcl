...
\
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M05_AXI [get_bd_intf_pins axi_dma_dac/S_AXI_LITE] [get_bd_intf_pins ps8_0_axi_periph/M05_AXI]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M07_AXI [get_bd_intf_pins fifo_controller/S_AXI_Lite] [get_bd_intf_pins ps8_0_axi_periph/M07_AXI]
  ...
  connect_bd_net -net Net [get_bd_pins clk_wiz_1/clk_333M] [get_bd_pins axi_dma_dac/m_axi_mm2s_aclk] [get_bd_pins axi_dma_dac/m_axi_sg_aclk] [get_bd_pins axi_dma_dac/s_axi_lite_aclk] [get_bd_pins axis_data_fifo_1/s_axis_aclk] [get_bd_pins axis_ssr_converter_dac/aclk] [get_bd_pins axis_tkeep_pack_0/aclk] [get_bd_pins rst_dac_333M/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp2_fpd_aclk] [get_bd_pins ps8_0_axi_periph/M05_ACLK]
  ...
  connect_bd_net -net rfdc_clk_dac0 [get_bd_pins rfdc/clk_dac0] [get_bd_pins axis_data_fifo_1/m_axis_aclk] [get_bd_pins clk_wiz_1/clk_in1] [get_bd_pins fifo_controller/aclk] [get_bd_pins rfdc/s0_axis_aclk] [get_bd_pins rst_dac_153M6/slowest_sync_clk] [get_bd_pins ps8_0_axi_periph/M07_ACLK]
  ...
  connect_bd_net -net rst_307M3_peripheral_aresetn [get_bd_pins rst_dac_153M6/peripheral_aresetn] [get_bd_pins clk_wiz_1/resetn] [get_bd_pins fifo_controller/aresetn] [get_bd_pins rfdc/s0_axis_aresetn] [get_bd_pins ps8_0_axi_periph/M07_ARESETN]
  ...
  connect_bd_net -net rst_dac_333M_peripheral_aresetn [get_bd_pins rst_dac_333M/peripheral_aresetn] [get_bd_pins axi_dma_dac/axi_resetn] [get_bd_pins axis_data_fifo_1/s_axis_aresetn] [get_bd_pins axis_ssr_converter_dac/aresetn] [get_bd_pins axis_tkeep_pack_0/aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins ps8_0_axi_periph/M05_ARESETN]
